-- ============================================================================
--  myRPS — CURRICULUM 2026 + FIXES
--
--  Adds the 2026 curriculum version, so students starting in session
--  2026/2027 have the right option in their profile.
--
--  Run it ONCE, after MIGRATE_TERMS.sql.
