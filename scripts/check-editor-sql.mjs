...
const files = ['RUN_THIS_IN_SUPABASE.sql', 'FIX_MY_LOGIN.sql', 'MIGRATE_TERMS.sql', 'MIGRATE_FIXES.sql', 'MIGRATE_FEED.sql', 'MIGRATE_AVATARS.sql', 'MIGRATE_PROFILES.sql', 'MIGRATE_VISIBLE_PROFILES.sql']
let bad = false
