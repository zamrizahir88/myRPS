-- ============================================================================
--  myRPS — SEMESTER TRACKING UPDATE
--
--  Adds year / semester / academic session recording, and test accounts.
--  Run it ONCE, after RUN_THIS_IN_SUPABASE.sql and FIX_MY_LOGIN.sql.
--
--  Supabase → SQL Editor → New query → paste all of this → Run.
--  Nothing to edit. It does not touch anything students have already entered.
-- ============================================================================
...
-- ============================================================================
select 'semester tracking' as item,
       case when exists (select 1 from information_schema.tables
                          where table_schema = 'public' and table_name = 'student_terms')
