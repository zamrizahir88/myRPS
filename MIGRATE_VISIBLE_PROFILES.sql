-- ============================================================================
--  myRPS — STUDENT PROFILES VISIBLE BY DEFAULT
--
--  Classmates can now see each other's profile without switching anything on.
--  Each student keeps a switch to turn any part off.
--
--  Run it ONCE, after MIGRATE_PROFILES.sql.
...
-- ============================================================================
select 'new accounts visible by default' as item,
